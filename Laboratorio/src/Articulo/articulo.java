...
public class articulo extends javax.swing.JInternalFrame {
    ...
    int GuardarArticulo(String descripcion){
       int res=-1;
        try {
            String query="INSERT into articulo (descripcion) VALUES (?)";
    ...
    void comparar(){
        ...
        if (GuardarArticulo(txtDescripcion.getText().trim())>-1) {
    ...
    void getAll(){
        try {
            ...
            //db
            String query="SELECT * FROM articulo a";
            PreparedStatement ps=db.prepareStatement(query);
            ...
            while(rs.next()){
                ...
                data[1]=rs.getString("a.idArticulo");
                data[2]=rs.getString("a.descripcion");
                m.addRow(data);
            }
            ps.close();
            rs.close();
    ...
    void delete(int id) {
        try {
            String query = "DELETE from articulo where idArticulo = '" + id + "' ";
            PreparedStatement ps = db.prepareStatement(query);
